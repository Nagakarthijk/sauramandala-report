...
const SIMULATOR_SCENARIOS = {
  ...
  "scenarios": [
    ...
    {
      "id": "SCN-04",
      "title": "Boatman pool doesn't respond — escalates to 108/CNES",
      "summary": "SOP-3 step 4: nobody in the private boatman pool accepts within the escalation window, so the case automatically escalates to the 108/CNES ambulance channel and gets flagged for control-room attention.",
      "actors": [
        { "id": "worker", "label": "Rina — ASHA (Worker)", "channel": "whatsapp", "role": "worker" },
        { "id": "boat1", "label": "Abdul — Boatman", "channel": "whatsapp", "role": "boatman" },
        { "id": "boat2", "label": "Salim — Boatman", "channel": "whatsapp", "role": "boatman" },
        { "id": "ambulance", "label": "108/CNES Dispatch", "channel": "whatsapp", "role": "ambulance" }
      ],
      "beats": [
        { "at": 0, "actor": "worker", "from": "worker", "kind": "text", "body": "EMERGENCY" },
        ...
        { "at": 9500, "actor": "dashboard", "from": "system", "kind": "case_update", "status": "escalated-manual", "body": "Timeout — neither boatman accepted. Escalating to 108/CNES. Flagged on dashboard for control-room follow-up on why the private pool didn't respond." },
        ...
        { "at": 11800, "actor": "dashboard", "from": "system", "kind": "case_update", "status": "boat-assigned", "body": "108/CNES dispatched. Rest of flow (facility, arrival, close) proceeds as in Scenario 1." },
        { "at": 12100, "actor": "boat1", "from": "bot", "kind": "text", "body": "This case has been reassigned to 108/CNES." },
        { "at": 12100, "actor": "boat2", "from": "bot", "kind": "text", "body": "This case has been reassigned to 108/CNES." }
      ]
    },
    {
      "id": "SCN-05",
